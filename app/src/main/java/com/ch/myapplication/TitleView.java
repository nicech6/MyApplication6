...
public class TitleView extends RelativeLayout {
    ...
    public TitleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLeftTextViewColor = array.getColor(R.styleable.TitleView_title_left_color, context.getResources().getColor(R.color.colorPrimary));
        mCenterTextViewColor = array.getColor(R.styleable.TitleView_title_center_color, context.getResources().getColor(R.color.colorPrimary));
        mRightTextViewColor = array.getColor(R.styleable.TitleView_title_right_color, context.getResources().getColor(R.color.colorPrimary));
